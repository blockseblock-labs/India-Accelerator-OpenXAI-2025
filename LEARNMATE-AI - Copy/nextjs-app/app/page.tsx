...
export default function LearnAI() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-red-500 animate-gradient bg-[length:400%_400%]">
                            ...
                            selectedAnswer === null
                             ...
                             : selectedAnswer === index
                              ? index === quiz[currentQuestion].correct
                                ? 'bg-green-500 text-white shadow-lg scale-105 transition-all duration-200'
                                : 'bg-red-500 text-white shake transition-all duration-200'
