...
              className="flex items-center gap-2 px-3 py-2 bg-indigo-600 hover:bg-indigo-700 disabled:bg-gray-600 rounded"
            >
...
            <button
              onClick={resetEarth}
              className="flex items-center gap-2 px-3 py-2 bg-teal-600 hover:bg-teal-700 rounded"
            >
              <RotateCcw size={16} />
              Reset Earth
            </button>
...
                disabled={isProcessing}
                className="flex-1 px-3 py-2 bg-gray-900 border border-gray-600 rounded text-white placeholder-gray-400 disabled:bg-gray-700"
              />
              <button
                type="submit"
...
              <div className="max-h-32 overflow-y-auto bg-gray-900 p-3 rounded">
...
              <div key={index} className="text-xs border-l-2 border-purple-500 pl-2">
