...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-r from-green-200 via-blue-200 to-purple-200">
      {/* Navbar */}
      <header className="bg-black text-white p-4 shadow-md flex justify-between items-center">
        <h1 className="text-xl font-bold">🌍 AI Climate Simulator</h1>
        <nav>
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center p-6">
        <h2 className="text-3xl font-bold mb-4">Welcome to the Future of Climate Simulation</h2>
        <p className="max-w-2xl text-lg mb-6">
          This AI-powered tool lets you explore different climate scenarios and visualize
          their impact. Adjust settings, run simulations, and see possible outcomes.
        </p>
        <button className="bg-green-600 text-white px-6 py-3 rounded-2xl shadow-lg hover:bg-green-700 transition">
          🚀 Run Simulation
        </button>
      </main>
