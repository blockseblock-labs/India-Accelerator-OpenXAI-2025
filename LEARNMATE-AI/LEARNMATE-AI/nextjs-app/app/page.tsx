...
export default function LearnAI() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-indigo-500 to-cyan-400">
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-5xl font-extrabold text-yellow-300 drop-shadow-lg mb-6">🚀 LearnAI</h1>
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2 flex space-x-2">
            {[
              { id: 'flashcards', label:'🃏 Study Cards', desc: 'Make Flashcards' },
              ...
              <div className="space-y-4 max-h-96 overflow-y-auto">
                ...
                {chatHistory.length === 0 && (
                  <div className="text-center text-white/60 py-8">
                   <i> Ask me anything and I'll help you learn! I can explain concepts, provide examples, and answer your questions.</i>
                  </div>
                )}
              </div>
            </div>
