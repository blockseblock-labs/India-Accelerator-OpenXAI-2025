...
export default function SocialNetwork() {
  ...
  return (
    <div className="min-h-screen animate-gradient bg-gradient-to-br from-pink-400 via-purple-500 via-fuchsia-500 to-indigo-600">
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="tab-content">
              <div className="social-card rounded-xl p-6">
                ...
                <p className="text-white/80 mb-6">
                  Describe your image and get an Instagram-ready caption!
                </p>
                ...
                <div className="space-y-4">
                  ...
                  {generatedCaption && (
                    <div className="bg-white/20 rounded-lg p-4 space-y-3">
                      ...
                      <button
                        onClick={() =>
                          copyToClipboard(generatedCaption, "caption")
                        }
          ...
          {activeTab === "mood" && (
            <div className="tab-content">
              <div className="social-card rounded-xl p-6">
                ...
                <p className="text-white/80 mb-6">
                  Paste any text to analyze its emotional sentiment!
                </p>
                ...
                <div className="space-y-4">
                  ...
                  {moodResult && (
                    <div className="bg-white/20 rounded-lg p-6 text-center space-y-4">
                      <div className="mood-indicator text-6xl">
                        {moodResult.emoji}
                      </div>
                      <div>
                        ...
                        <p className="text-white/80">
                          Detected sentiment with {moodResult.confidence}{" "}
                          confidence
                        </p>
                      </div>
                    </div>
          ...
          {activeTab === "hashtags" && (
            <div className="tab-content">
              <div className="social-card rounded-xl p-6">
                ...
                <p className="text-white/80 mb-6">
                  Enter keywords and get trending hashtags for your post!
                </p>
        ...
        <div className="text-center mt-12 text-white/60">
          <p>
            Perfect for Instagram, Twitter, TikTok, and all your social
            platforms! 🚀
          </p>
        </div>
      </div>
