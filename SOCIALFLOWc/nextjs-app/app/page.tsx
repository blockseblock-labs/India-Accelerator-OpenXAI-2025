    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300 p-8">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-6xl font-extrabold text-black mb-2 tracking-tight drop-shadow-xl rounded-2xl max-w-5xl mx-auto text-center"> 🤖 Social Network AI </h1>
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-black/40 backdrop-blur-sm rounded-lg p-2 flex space-x-2">
            {[
              { id: 'caption', label: '🖼️ Caption', desc: 'Generate Captions', gradient: 'instagram-gradient'},
              { id: 'mood', label: '🙂 Mood', desc: 'Check Sentiment', gradient: 'twitter-gradient' },
              { id: 'hashtags', label: '🔖 Hashtags', desc: 'Suggest Tags', gradient: 'social-gradient' }
            ].map(tab => (
              <button
                key={tab.id}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          {activeTab === 'caption' && (
            <div className="tab-content">
              <div className="social-card rounded-xl p-6">
                <h2 className="text-2xl font-bold text-black mb-4">🖼️ Caption Generator</h2>
          ...
          {activeTab === 'mood' && (
            <div className="tab-content">
              <div className="social-card rounded-xl p-6">
                <h2 className="text-2xl font-bold text-black mb-4">🙂 Mood Checker</h2>
                ...
                <div className="space-y-4">
                  ...
                  >
                    {loading ? 'Analyzing Mood...' : 'Check Mood 🕵️'}
                  </button>
          ...
          {activeTab === 'hashtags' && (
            <div className="tab-content">
              <div className="social-card rounded-xl p-6">
                <h2 className="text-2xl font-bold text-black mb-4">🔖 Hashtag Suggestor</h2>
